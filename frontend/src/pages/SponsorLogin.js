...
function SponsorLogin() {
  ...
  const slides = [
    {
      image: img1,
      quote: "Pitch Partner opened new sponsorship opportunities for us. The platform is incredibly efficient and professional!",
      name: "Laura Bianchi",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await sponsorAPI.login(email, password);
      setAuth(response.data.access_token, { ...response.data.sponsor, role: 'sponsor' });
    ...
    <div className="modern-login-container">
      ...
      <div className="login-right-section">
        <div className="login-form-container">
          ...
          <div className="portal-badge">Sponsor Portal</div>
